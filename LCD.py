...
class LCD:
    def __init__(self, pi_rev = 2, i2c_addr = 0x3F, backlight = True):
        ...
        self.LCD_LINE_3 = 0x94 # LCD RAM addr for line three
        self.LCD_LINE_4 = 0xD4 # LCD RAM addr for line four
    ...
    def message(self, string, line = 1):
        # display message string on LCD line 1, 2, 3, or 4
        if line == 1:
            ...
            raise ValueError('line number must be 1, 2, 3, or 4')
